      ...
      <div className="hero relative h-[90vh] bg-[#000000e6]">
        <div className="hero-content">
          ...
          <div className="text-center text-gray-100">
            <h1 className="lg:text-7xl md:text-6xl text-5xl font-extrabold">Choose Your Favourite Car</h1>
       ...
       <svg className="absolute right-0 bottom-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#fff" fill-opacity="1" d="M0,288L1440,192L1440,320L0,320Z"></path></svg>
       </div>
        </div>
      </div>
    </section>
